...
# Shared taint config for JS-family languages (JS, JSX, TS, TSX)
_JS_TAINT_FIELDS = dict(
...
_LANG_REGISTRY.update(
    {
        ".js": (ts_javascript, LanguageConfig(**_JS_TAINT_FIELDS)),
        ".jsx": (ts_javascript, LanguageConfig(**_JS_TAINT_FIELDS)),
        ".ts": (language_typescript, LanguageConfig(**_JS_TAINT_FIELDS)),
        ".tsx": (language_tsx, LanguageConfig(**_JS_TAINT_FIELDS)),
        ".go": (
            ts_go,
            LanguageConfig(
